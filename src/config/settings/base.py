...
TIME_ZONE = config("DJANGO_TIMEZONE", default="Australia/Melbourne")
...
CRISPY_TEMPLATE_PACK = "crispywind"
CRISPY_ALLOWED_TEMPLATE_PACKS = "crispywind"
...
# django-allauth
# ------------------------------------------------------------------------------
ACCOUNT_ALLOW_REGISTRATION = config("DJANGO_ACCOUNT_ALLOW_REGISTRATION", default=True)
# https://docs.allauth.org/en/latest/account/configuration.html
# Set Login method. Choices are "username", "email", or "username_email" which means user either.
